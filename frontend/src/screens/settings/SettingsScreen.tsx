...
/**
 * Profile + privacy settings. Renders the user's current avatar and the read-receipt sharing toggle
 * (mirrors the web). Changing the photo from the phone needs a native image picker (a follow-up); an
 * avatar uploaded on the web already shows here.
 */
