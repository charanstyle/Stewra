...
### website-dev-guidelines
**Purpose:** Vite + React + TypeScript web development patterns (website/ directory)
...
**Use when:**
- Creating web components or pages
- Styling with CSS Modules
- Using Radix UI components
- Setting up web routing
- Building web features

**Customization:** ⚠️ Update `pathPatterns` to match your web directory

**Example pathPatterns:**
```json
{
  "pathPatterns": [
    "website/src/**/*.tsx",  // Website directory
    "web/src/**/*.tsx",      // Web directory
    "apps/web/**/*.tsx"      // Monorepo web app
  ]
}
```

**Note:** This skill is configured as a **guardrail** (enforcement: "block") to enforce web best practices.

**[View Skill →](website-dev-guidelines/)**

---

### react-native-dev-guidelines
**Purpose:** React Native + Expo mobile development patterns (frontend/ directory)

**Files:** 1 main file

**Covers:**
- React Native mobile patterns
- Expo SDK modules (Camera, Notifications, etc.)
- React Navigation
- StyleSheet styling
...
**Use when:**
- Creating mobile screens or components
- Using Expo modules
- Navigation with React Navigation
- Styling with StyleSheet
- Building mobile features

**Customization:** ⚠️ Update `pathPatterns` to match your mobile directory
...
```json
{
  "pathPatterns": [
    ...
    "mobile/src/**/*.tsx",   // Mobile directory
    "apps/mobile/**/*.tsx"   // Monorepo mobile app
  ]
}
```

**Note:** This skill is configured as a **guardrail** (enforcement: "block") to enforce React Native best practices.

**[View Skill →](react-native-dev-guidelines/)**
